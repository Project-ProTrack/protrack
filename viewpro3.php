...
$data = " SELECT project.projectid, project.projectname,usersdata.name,project.deadline FROM project  JOIN usersdata ON project.projecthead = usersdata.userid where project.projectid='103'";

$result=mysqli_query($connection,$data);
$result1=   "SELECT  usersdata.name FROM project  JOIN usersdata ON project.m1 = usersdata.userid where  project.projectid='103' ";  
 $result2=mysqli_query($connection,$result1);
 $result3="SELECT  usersdata.name FROM project  JOIN usersdata ON project.m2 = usersdata.userid where  project.projectid='103' ";
 $result4=mysqli_query($connection,$result3);
$result5=" SELECT  usersdata.name FROM project  JOIN usersdata ON project.m3 = usersdata.userid where  project.projectid='103'  ";
$result6=mysqli_query($connection,$result5);
$result7="SELECT  usersdata.name FROM project  JOIN usersdata ON project.m4= usersdata.userid where  project.projectid='103' ";
$result8=mysqli_query($connection,$result7);
$result9=" SELECT  usersdata.name FROM project  JOIN usersdata ON project.m5 = usersdata.userid where  project.projectid='103' ";
$result10=mysqli_query($connection,$result9);
$result11="SELECT  usersdata.name FROM project  JOIN usersdata ON project.m6 = usersdata.userid where  project.projectid='103'";
$result12=mysqli_query($connection,$result11);
$res="SELECT    projectname from    project where  project.projectid='103'";
